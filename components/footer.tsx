...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative mt-auto border-t border-white/10 bg-black/90"
      style={{
        background: `
    ...
    >
      ...
      <div ref={contentRef} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex flex-row items-center justify-between gap-4">
          {/* Copyright - Left aligned on all screens */}
          <div className="footer-element flex items-center">
